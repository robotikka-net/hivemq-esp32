...
const char* ssid = "Robotikka";
const char* password = "robotikka.net";

/******* MQTT Broker Connection Details *******/
const char* mqtt_server = "7f361708e39549c78c5b9635424a286e.s2.eu.hivemq.cloud";
const char* mqtt_username = "robotikkamqtt";
const char* mqtt_password = "32706120Una@";
